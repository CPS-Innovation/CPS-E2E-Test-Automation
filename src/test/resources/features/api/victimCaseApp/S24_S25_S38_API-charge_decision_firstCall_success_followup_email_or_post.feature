@regression @vca_api_regression @VCA_API_S24 @VCA_API_S25 @VCA_API_S38 @Test1

Feature: VCA-API-S24-S25-S38:- Log charge decision communication where first call attempt was successful and follow up communication is sent in email or post for victims in Victim Case Application.
  ...
  Scenario: Log charge decision communication where first call attempt was successful and follow up communication is sent in email for victim. (FCT2-16349 & 16369 & 16382)
    ...
    Then verify the charge decision telephone and followup communication for "victim" in VCA
      ...
      | Inform of a no further action decision | Post           | first       | No      |
      #  journeyType :- Inform of a no further action decision or #  Inform of a decision to charge