@regression @CR_UI_S4_S10_S16_S22 @caseReview
Feature: CR-UI-S4_S10_S16_S22 - CCU Initial PCD Review
...
#    @ui @CR_UI_16403 @CR_UI_S22 @fullCodeMultiSuspectWith1DayActionPlan
#  Scenario: 28 days PCD review of test type full code for multi suspect with 28 days action plan
#    Given I login to case review app
#    And Search the case "URN"
#    When I start "5 day PCD Review"
#    And select test as "Full Code Test"
